...
export class PlayerObject extends Group {
	...
	shift() {
		this.skin.head.position.y = -2.5;
		this.skin.body.position.y = -7;
		this.skin.body.position.z = -2;
		this.skin.body.rotation.x = 28 * Math.PI / 180;
		this.skin.rightArm.position.y = -3.5;
		this.skin.rightArm.rotation.x = 20 * Math.PI / 180
		this.skin.rightLeg.position.x = -1.9;
		this.skin.rightLeg.position.y = -11;
		this.skin.rightLeg.position.z = -3.4;
		this.skin.leftArm.position.y = -3.5;
		this.skin.leftArm.rotation.x = 20 * Math.PI / 180;
		this.skin.leftLeg.position.x = 1.9;
		this.skin.leftLeg.position.y = -11;
		this.skin.leftLeg.position.z = -3.4;
		this.cape.position.y = 7;
		this.cape.position.z = -1.15;
		this.cape.rotation.x = 32 * Math.PI / 180;
		this.cape.rotation.y = Math.PI;
		this.elytra.position.y = 9;
		this.elytra.position.z = -1;
		this.shifting = true;
	}

	unshift() {
		this.skin.head.position.y = 0;
		this.skin.body.position.y = -6;
		this.skin.body.position.z = 0;
		this.skin.body.rotation.x = 0;
		this.skin.rightArm.position.y = -2;
		this.skin.rightArm.rotation.x = 0;
		this.skin.leftArm.position.y = -2;
		this.skin.leftArm.rotation.x = 0;
		this.skin.rightLeg.position.x = -1.9;
		this.skin.rightLeg.position.y = -12;
		this.skin.rightLeg.position.z = -.1;
		this.skin.leftLeg.position.x = 1.9;
		this.skin.leftLeg.position.y = -12;
		this.skin.leftLeg.position.z = -.1;
		this.cape.position.y = 8;
		this.cape.position.z = -2;
		this.cape.rotation.x = 10.8 * Math.PI / 180;
		this.cape.rotation.y = Math.PI;
		this.elytra.position.y = 10;
